                ...
                <div class="row mb-5">
                    <div class="col-12 col-xl d-flex align-items-center justify-content-between">
                        <div class=" d-flex align-items-center">
                            <label for="" class="required form-label mb-3 fw-bold" style="text-align: justify;">Skor yang dihitung berasal dari jurnal yang dilakukan dengan tipe publikasi Nscopus dan Scopus</label>
                        </div>
                    </div>
                </div>
                <div class="row mb-5">
...
@include('dosennonpublikasi::javascript')