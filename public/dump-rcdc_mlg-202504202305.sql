...
CREATE TABLE `database_dosen` (
  `kode_dosen` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `jja_dosen` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ft_dosen` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `identitas_dosen`
--

DROP TABLE IF EXISTS `identitas_dosen`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `identitas_dosen` (
  `id_identitas` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kode_dosen` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `foto_dosen` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_dosen` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telp_dosen` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `website_dosen` text COLLATE utf8mb4_unicode_ci,
  `expertise_dosen` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id_identitas`),
  KEY `identitas_dosen_kode_dosen_IDX` (`kode_dosen`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `identitas_dosen`
--

LOCK TABLES `identitas_dosen` WRITE;
/*!40000 ALTER TABLE `identitas_dosen` DISABLE KEYS */;
/*!40000 ALTER TABLE `identitas_dosen` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `presensi_event`
--
...
CREATE TABLE `presensi_event` (
  `id_presensi` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kode_dosen` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id_presensi`),
  KEY `presensi_event_kode_dosen_IDX` (`kode_dosen`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `presensi_event`
--

LOCK TABLES `presensi_event` WRITE;
/*!40000 ALTER TABLE `presensi_event` DISABLE KEYS */;
INSERT INTO `presensi_event` VALUES ('PR001','D6263',NULL,NULL),('PR002','D6070',NULL,NULL),('PR003','D5868',NULL,NULL);
/*!40000 ALTER TABLE `presensi_event` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sys_menu` (
  ...
  `menu_kode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `menu_judul` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `menu_order` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `menu_parent` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `menu_aktif` int DEFAULT NULL,
  ...
  `menu_sub` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`menu_id`),
  UNIQUE KEY `sys_menu_menu_kode_unique` (`menu_kode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_menu` VALUES ('A001','dashboard','Dashboard','00','#',1,'las la-user fs-2x','1',1,'2024-10-16 17:54:29','2024-10-16 17:54:29'),('A0011','home','Home','00.01','A001',1,'las la-user fs-2x','2',0,'2024-10-16 17:54:29','2024-10-16 17:54:29'),('A0012','dosen','Dosen','00.02','A001',1,'las la-user fs-2x','2',0,'2024-10-16 17:54:29','2024-10-16 17:54:29'),('A0013','perhitungankpi','Perhitungan KPI','00.03','A001',1,'las la-user fs-2x','2',0,'2024-10-16 17:54:29','2024-10-16 17:54:29'),('A0014','rcdcevent','Event','00.04','A001',1,'las la-user fs-2x','2',0,'2024-10-16 17:54:29','2024-10-16 17:54:29');
...
INSERT INTO `sys_role` VALUES ('OWN001','Owner','2024-10-16 17:54:29','2024-10-16 17:54:29');
...
CREATE TABLE `sys_role_menu` (
  `role_menu_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `role_menu_menu_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `role_menu_role_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `sys_role_menu` VALUES ('39a575a40ac94909acf195b3e543aced','A001','OWN001',NULL,NULL),('526b9138b4827c6b4369c01199068414','A0011','OWN001',NULL,NULL),('526b9138b4827c6b4369c01199068415','A0012','OWN001',NULL,NULL),('526b9138b4827c6b4369c01199068416','A0013','OWN001',NULL,NULL),('526b9138b4827c6b4369c01199068417','A0014','OWN001',NULL,NULL);
...
CREATE TABLE `tblauthsessions` (
  ...
  `txtSessionKey` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dtExpires` datetime DEFAULT NULL,
  `txtRedir` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `txtRefreshToken` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `txtCodeVerifier` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `txtToken` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `txtIDToken` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
--
-- Temporary view structure for view `view_sys_role_menu`
--

DROP TABLE IF EXISTS `view_sys_role_menu`;
/*!50001 DROP VIEW IF EXISTS `view_sys_role_menu`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_sys_role_menu` AS SELECT 
 1 AS `role_menu_id`,
 1 AS `role_menu_menu_id`,
 1 AS `role_menu_role_id`,
 1 AS `menu_id`,
 1 AS `menu_kode`,
 1 AS `menu_judul`,
 1 AS `menu_order`,
...
--
-- Final view structure for view `view_sys_role_menu`
--
...
/*!50001 VIEW `view_sys_role_menu` AS select `crm`.`role_menu_id` AS `role_menu_id`,`crm`.`role_menu_menu_id` AS `role_menu_menu_id`,`crm`.`role_menu_role_id` AS `role_menu_role_id`,`cm`.`menu_id` AS `menu_id`,`cm`.`menu_kode` AS `menu_kode`,`cm`.`menu_judul` AS `menu_judul`,`cm`.`menu_order` AS `menu_order`,`cm`.`menu_parent` AS `menu_parent`,`cm`.`menu_aktif` AS `menu_aktif`,`cm`.`menu_icon` AS `menu_icon`,`cm`.`menu_level` AS `menu_level`,`cm`.`menu_sub` AS `menu_sub`,`cm`.`created_at` AS `created_at`,`cm`.`updated_at` AS `updated_at`,`cr`.`role_id` AS `role_id`,`cr`.`role_name` AS `role_name` from ((`sys_role_menu` `crm` left join `sys_menu` `cm` on((`crm`.`role_menu_menu_id` = `cm`.`menu_id`))) left join `sys_role` `cr` on((`crm`.`role_menu_role_id` = `cr`.`role_id`))) */;
...
-- Dump completed on 2025-04-20 23:05:18
