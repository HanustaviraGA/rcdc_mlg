  ...
  <main class="main">
    ...
    @if(isset($researchs) && !empty($researchs))
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-lg-12 content" data-aos="fade-right" data-aos-delay="200">
                <h2>Riset & Inovasi</h2>
                <p>BINUS@Malang senantiasa berperan serta dalam proses pengembangan ilmu pengetahuan melalui riset dan inovasi</p>
            </div>
            ...
            <div class="projects-grid mt-5">
                @foreach($researchs as $list_research)
                    @php
                        $randr = rand(1, 4) * 100
                    @endphp
                    <div class="project-item" data-aos="zoom-in" data-aos-delay="{{ $randr }}">
                        <div class="project-content">
                        <div class="project-header">
                            {{-- <span class="project-category">Commercial</span>
                            <span class="project-status completed">Completed</span> --}}
                        </div>
                        <h3 class="project-title" style="text-align: justify !important;">{{ $list_research['title'] }}</h3>
                        <div class="project-details">
                            <div class="project-info">
                            <p style="text-align: justify !important;">{{ truncateDescription($list_research['abstract'], 200) }}</p>
                        ...
                        <img src="{{ asset('landing/assets/img/construction/project-2.webp') }}" alt="Metropolitan Office Tower" class="img-fluid">
            ...
            {{-- <div class="project-item" data-aos="zoom-in" data-aos-delay="200">
                ...
                <div class="project-visual">
                <img src="{{ asset('landing/assets/img/construction/project-6.webp') }}" alt="Riverside Luxury Homes" class="img-fluid">
                <div class="project-badge">
                    <i class="bi bi-tools"></i>
                </div>
                </div>
            ...
            <div class="project-item" data-aos="zoom-in" data-aos-delay="300">
                ...
                <div class="project-visual">
                <img src="{{ asset('landing/assets/img/construction/project-10.webp') }}" alt="Highway Bridge Reconstruction" class="img-fluid">
                <div class="project-badge">
                    <i class="bi bi-gear"></i>
                </div>
                </div>
            ...
            <div class="project-item" data-aos="zoom-in" data-aos-delay="100">
                ...
                <div class="project-visual">
                <img src="{{ asset('landing/assets/img/construction/project-4.webp') }}" alt="Children's Medical Facility" class="img-fluid">
                <div class="project-badge">
            ...
            <div class="project-item" data-aos="zoom-in" data-aos-delay="200">
                ...
                <div class="project-visual">
                <img src="{{ asset('landing/assets/img/construction/project-8.webp') }}" alt="Innovation Campus Center" class="img-fluid">
                <div class="project-badge">
            ...
            <div class="project-item" data-aos="zoom-in" data-aos-delay="300">
                ...
                <div class="project-visual">
                <img src="{{ asset('landing/assets/img/construction/project-12.webp') }}" alt="Green Energy Plant" class="img-fluid">
                <div class="project-badge">
